...
1. You will start by working on a new feature or bug fix.
2. Once you are finished, you will use the `codex` command to have the Codex agent review your work.
3. The Codex agent will review your code, update the README file, and push your changes to the Git repository.
