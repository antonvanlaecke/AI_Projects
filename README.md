...
- Dark/light toggle in the header (powered by `site/assets/css/dark.css` + `site/assets/js/theme.js`) defaults to the system preference and can be overridden per visitor.
